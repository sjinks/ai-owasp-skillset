---
name: security-review-owasp-jaas
description: Review JAAS concerns, trust boundaries, and operational assumptions against OWASP JAAS guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP JAAS Security Review

Apply this skill to security reviews focused on JAAS concerns across code, configuration, architecture, and operational controls.
