---
name: security-review-owasp-web-service-security
description: Review Web Service Security concerns, trust boundaries, and operational assumptions against OWASP Web Service Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Web Service Security Review

Apply this skill to security reviews focused on Web Service Security concerns across code, configuration, architecture, and operational controls.
