---
name: security-review-owasp-http-headers
description: Review HTTP Headers concerns, trust boundaries, and operational assumptions against OWASP HTTP Headers guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP HTTP Headers Security Review

Apply this skill to security reviews focused on HTTP Headers concerns across code, configuration, architecture, and operational controls.
