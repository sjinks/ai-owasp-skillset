---
name: security-review-owasp-mcp-security
description: Review MCP Security concerns, trust boundaries, and operational assumptions against OWASP MCP Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP MCP Security Review

Apply this skill to security reviews focused on MCP Security concerns across code, configuration, architecture, and operational controls.
