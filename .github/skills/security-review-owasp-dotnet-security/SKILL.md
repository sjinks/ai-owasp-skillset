---
name: security-review-owasp-dotnet-security
description: Review .NET Security concerns, trust boundaries, and operational assumptions against OWASP .NET Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP .NET Security Review

Apply this skill to security reviews focused on .NET Security concerns across code, configuration, architecture, and operational controls.
