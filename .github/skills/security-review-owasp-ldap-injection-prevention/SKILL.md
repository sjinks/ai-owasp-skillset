---
name: security-review-owasp-ldap-injection-prevention
description: Review LDAP Injection Prevention concerns, trust boundaries, and operational assumptions against OWASP LDAP Injection Prevention guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP LDAP Injection Prevention Security Review

Apply this skill to security reviews focused on LDAP Injection Prevention concerns across code, configuration, architecture, and operational controls.
