---
name: security-review-owasp-ajax-security
description: Review AJAX Security concerns, trust boundaries, and operational assumptions against OWASP AJAX Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP AJAX Security Review

Apply this skill to security reviews focused on AJAX Security concerns across code, configuration, architecture, and operational controls.
