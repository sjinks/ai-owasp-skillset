...
description: Review Dependency Graph SBOM concerns, trust boundaries, and operational assumptions against OWASP Dependency Graph SBOM guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Dependency Graph SBOM Security Review

Apply this skill to security reviews focused on Dependency Graph SBOM concerns across code, configuration, architecture, and operational controls.
