---
name: security-review-owasp-cryptographic-storage
description: Review Cryptographic Storage concerns, trust boundaries, and operational assumptions against OWASP Cryptographic Storage guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Cryptographic Storage Security Review

Apply this skill to security reviews focused on Cryptographic Storage concerns across code, configuration, architecture, and operational controls.
