---
name: security-review-owasp-secure-cloud-architecture
description: Review Secure Cloud Architecture concerns, trust boundaries, and operational assumptions against OWASP Secure Cloud Architecture guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Secure Cloud Architecture Security Review

Apply this skill to security reviews focused on Secure Cloud Architecture concerns across code, configuration, architecture, and operational controls.
