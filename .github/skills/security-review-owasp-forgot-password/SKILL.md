---
name: security-review-owasp-forgot-password
description: Review Forgot Password concerns, trust boundaries, and operational assumptions against OWASP Forgot Password guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Forgot Password Security Review

Apply this skill to security reviews focused on Forgot Password concerns across code, configuration, architecture, and operational controls.
...
- Use the examples as recognition aids, not as a substitute for reviewing token issuance, proof-of-possession, and session-transition behavior end to end.
