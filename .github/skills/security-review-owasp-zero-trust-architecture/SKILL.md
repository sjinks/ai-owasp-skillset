---
name: security-review-owasp-zero-trust-architecture
description: Review Zero Trust Architecture concerns, trust boundaries, and operational assumptions against OWASP Zero Trust Architecture guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Zero Trust Architecture Security Review

Apply this skill to security reviews focused on Zero Trust Architecture concerns across code, configuration, architecture, and operational controls.
