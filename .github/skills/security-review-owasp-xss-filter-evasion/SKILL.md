---
name: security-review-owasp-xss-filter-evasion
description: Review XSS Filter Evasion concerns, trust boundaries, and operational assumptions against OWASP XSS Filter Evasion guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP XSS Filter Evasion Security Review

Apply this skill to security reviews focused on XSS Filter Evasion concerns across code, configuration, architecture, and operational controls.
