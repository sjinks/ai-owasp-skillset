---
name: security-review-owasp-os-command-injection-defense
description: Review OS Command Injection Defense concerns, trust boundaries, and operational assumptions against OWASP OS Command Injection Defense guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP OS Command Injection Defense Security Review

Apply this skill to security reviews focused on OS Command Injection Defense concerns across code, configuration, architecture, and operational controls.
