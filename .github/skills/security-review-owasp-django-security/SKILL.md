---
name: security-review-owasp-django-security
description: Review Django Security concerns, trust boundaries, and operational assumptions against OWASP Django Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Django Security Review

Apply this skill to security reviews focused on Django Security concerns across code, configuration, architecture, and operational controls.
