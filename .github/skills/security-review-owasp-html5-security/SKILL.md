---
name: security-review-owasp-html5-security
description: Review HTML5 Security concerns, trust boundaries, and operational assumptions against OWASP HTML5 Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP HTML5 Security Review

Apply this skill to security reviews focused on HTML5 Security concerns across code, configuration, architecture, and operational controls.
