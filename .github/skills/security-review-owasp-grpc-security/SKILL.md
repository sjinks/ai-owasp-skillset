---
name: security-review-owasp-grpc-security
description: Review gRPC Security concerns, trust boundaries, and operational assumptions against OWASP gRPC Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP gRPC Security Review

Apply this skill to security reviews focused on gRPC Security concerns across code, configuration, architecture, and operational controls.
