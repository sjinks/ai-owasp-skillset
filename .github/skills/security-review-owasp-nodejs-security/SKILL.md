---
name: security-review-owasp-nodejs-security
description: Review Node.js Security concerns, trust boundaries, and operational assumptions against OWASP Node.js Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Node.js Security Review

Apply this skill to security reviews focused on Node.js Security concerns across code, configuration, architecture, and operational controls.
