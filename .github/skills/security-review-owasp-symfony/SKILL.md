---
name: security-review-owasp-symfony
description: Review Symfony concerns, trust boundaries, and operational assumptions against OWASP Symfony guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Symfony Security Review

Apply this skill to security reviews focused on Symfony concerns across code, configuration, architecture, and operational controls.
