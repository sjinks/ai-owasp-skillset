---
name: security-review-owasp-browser-extension-vulnerabilities
description: Review Browser Extension Vulnerabilities concerns, trust boundaries, and operational assumptions against OWASP Browser Extension Vulnerabilities guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Browser Extension Vulnerabilities Security Review

Apply this skill to security reviews focused on Browser Extension Vulnerabilities concerns across code, configuration, architecture, and operational controls.
