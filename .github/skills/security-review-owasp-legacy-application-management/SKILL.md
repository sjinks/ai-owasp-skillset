---
name: security-review-owasp-legacy-application-management
description: Review Legacy Application Management concerns, trust boundaries, and operational assumptions against OWASP Legacy Application Management guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Legacy Application Management Security Review

Apply this skill to security reviews focused on Legacy Application Management concerns across code, configuration, architecture, and operational controls.
