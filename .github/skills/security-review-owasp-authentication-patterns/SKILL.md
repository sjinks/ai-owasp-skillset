---
name: security-review-owasp-authentication-patterns
description: Review Authentication Patterns concerns, trust boundaries, and operational assumptions against OWASP Authentication Patterns guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Authentication Patterns Security Review

Apply this skill to security reviews focused on Authentication Patterns concerns across code, configuration, architecture, and operational controls.
