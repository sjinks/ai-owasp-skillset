---
name: security-review-owasp-secure-product-design
description: Review Secure Product Design concerns, trust boundaries, and operational assumptions against OWASP Secure Product Design guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Secure Product Design Security Review

Apply this skill to security reviews focused on Secure Product Design concerns across code, configuration, architecture, and operational controls.
