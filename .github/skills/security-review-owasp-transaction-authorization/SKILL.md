---
name: security-review-owasp-transaction-authorization
description: Review Transaction Authorization concerns, trust boundaries, and operational assumptions against OWASP Transaction Authorization guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Transaction Authorization Security Review

Apply this skill to security reviews focused on Transaction Authorization concerns across code, configuration, architecture, and operational controls.
