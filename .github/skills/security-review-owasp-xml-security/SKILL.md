---
name: security-review-owasp-xml-security
description: Review XML Security concerns, trust boundaries, and operational assumptions against OWASP XML Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP XML Security Review

Apply this skill to security reviews focused on XML Security concerns across code, configuration, architecture, and operational controls.
