---
name: security-review-owasp-query-parameterization
description: Review Query Parameterization concerns, trust boundaries, and operational assumptions against OWASP Query Parameterization guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Query Parameterization Security Review

Apply this skill to security reviews focused on Query Parameterization concerns across code, configuration, architecture, and operational controls.
