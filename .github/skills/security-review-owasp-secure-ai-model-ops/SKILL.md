---
name: security-review-owasp-secure-ai-model-ops
description: Review Secure AI Model Ops concerns, trust boundaries, and operational assumptions against OWASP Secure AI Model Ops guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Secure AI Model Ops Security Review

Apply this skill to security reviews focused on Secure AI Model Ops concerns across code, configuration, architecture, and operational controls.
