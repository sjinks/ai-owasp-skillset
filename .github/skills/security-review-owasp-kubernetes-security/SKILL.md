---
name: security-review-owasp-kubernetes-security
description: Review Kubernetes Security concerns, trust boundaries, and operational assumptions against OWASP Kubernetes Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Kubernetes Security Review

Apply this skill to security reviews focused on Kubernetes Security concerns across code, configuration, architecture, and operational controls.
