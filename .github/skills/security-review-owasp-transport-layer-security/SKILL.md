---
name: security-review-owasp-transport-layer-security
description: Review Transport Layer Security concerns, trust boundaries, and operational assumptions against OWASP Transport Layer Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Transport Layer Security Review
...
- Use the examples as recognition aids, not as a substitute for reviewing certificate validation, TLS policy, and termination behavior across the full path.
