---
name: security-review-owasp-multi-tenant-security
description: Review Multi Tenant Security concerns, trust boundaries, and operational assumptions against OWASP Multi Tenant Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Multi Tenant Security Review

Apply this skill to security reviews focused on Multi Tenant Security concerns across code, configuration, architecture, and operational controls.
