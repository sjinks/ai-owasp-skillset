---
name: security-review-owasp-network-segmentation
description: Review Network Segmentation concerns, trust boundaries, and operational assumptions against OWASP Network Segmentation guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Network Segmentation Security Review

Apply this skill to security reviews focused on Network Segmentation concerns across code, configuration, architecture, and operational controls.
