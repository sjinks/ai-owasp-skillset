---
name: security-review-owasp-microservices-based-security-arch-doc
description: Review Microservices Based Security Arch Doc concerns, trust boundaries, and operational assumptions against OWASP Microservices Based Security Arch Doc guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Microservices Based Security Arch Doc Security Review
