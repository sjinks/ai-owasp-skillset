...
description: Review NPM Security concerns, trust boundaries, and operational assumptions against OWASP NPM Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP NPM Security Review

Apply this skill to security reviews focused on NPM Security concerns across code, configuration, architecture, and operational controls.
