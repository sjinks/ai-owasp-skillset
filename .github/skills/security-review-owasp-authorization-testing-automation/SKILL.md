---
name: security-review-owasp-authorization-testing-automation
description: Review Authorization Testing Automation concerns, trust boundaries, and operational assumptions against OWASP Authorization Testing Automation guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Authorization Testing Automation Security Review

Apply this skill to security reviews focused on Authorization Testing Automation concerns across code, configuration, architecture, and operational controls.
