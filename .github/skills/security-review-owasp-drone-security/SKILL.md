---
name: security-review-owasp-drone-security
description: Review Drone Security concerns, trust boundaries, and operational assumptions against OWASP Drone Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Drone Security Review

Apply this skill to security reviews focused on Drone Security concerns across code, configuration, architecture, and operational controls.
