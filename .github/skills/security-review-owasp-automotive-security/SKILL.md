---
name: security-review-owasp-automotive-security
description: Review Automotive Security concerns, trust boundaries, and operational assumptions against OWASP Automotive Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Automotive Security Review

Apply this skill to security reviews focused on Automotive Security concerns across code, configuration, architecture, and operational controls.
