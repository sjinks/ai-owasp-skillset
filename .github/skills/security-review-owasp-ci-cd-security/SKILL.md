---
name: security-review-owasp-ci-cd-security
description: Review CI/CD Security concerns, trust boundaries, and operational assumptions against OWASP CI/CD Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP CI/CD Security Review

Apply this skill to security reviews focused on CI/CD Security concerns across code, configuration, architecture, and operational controls.
