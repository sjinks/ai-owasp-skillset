---
name: security-review-owasp-pinning
description: Review Pinning concerns, trust boundaries, and operational assumptions against OWASP Pinning guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Pinning Security Review

Apply this skill to security reviews focused on Pinning concerns across code, configuration, architecture, and operational controls.
