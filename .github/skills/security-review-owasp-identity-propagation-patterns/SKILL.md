...
description: Review Identity Propagation Patterns concerns, trust boundaries, and operational assumptions against OWASP Identity Propagation Patterns guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Identity Propagation Patterns Security Review

Apply this skill to security reviews focused on Identity Propagation Patterns concerns across code, configuration, architecture, and operational controls.
