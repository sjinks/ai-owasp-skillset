---
name: security-review-owasp-cookie-theft-mitigation
description: Review Cookie Theft Mitigation concerns, trust boundaries, and operational assumptions against OWASP Cookie Theft Mitigation guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Cookie Theft Mitigation Security Review

Apply this skill to security reviews focused on Cookie Theft Mitigation concerns across code, configuration, architecture, and operational controls.
