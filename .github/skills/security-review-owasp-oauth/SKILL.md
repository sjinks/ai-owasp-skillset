...
description: Review OAuth concerns, trust boundaries, and operational assumptions against OWASP OAuth guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP OAuth Security Review

Apply this skill to security reviews focused on OAuth concerns across code, configuration, architecture, and operational controls.
