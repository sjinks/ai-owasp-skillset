...
description: Review Infrastructure as Code Security concerns, trust boundaries, and operational assumptions against OWASP Infrastructure as Code Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Infrastructure as Code Security Review

Apply this skill to security reviews focused on Infrastructure as Code Security concerns across code, configuration, architecture, and operational controls.
