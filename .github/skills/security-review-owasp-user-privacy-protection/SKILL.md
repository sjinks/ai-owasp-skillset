---
name: security-review-owasp-user-privacy-protection
description: Review User Privacy Protection concerns, trust boundaries, and operational assumptions against OWASP User Privacy Protection guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP User Privacy Protection Security Review

Apply this skill to security reviews focused on User Privacy Protection concerns across code, configuration, architecture, and operational controls.
