---
name: security-review-owasp-serverless-faas-security
description: Review Serverless FaaS Security concerns, trust boundaries, and operational assumptions against OWASP Serverless FaaS Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Serverless FaaS Security Review

Apply this skill to security reviews focused on Serverless FaaS Security concerns across code, configuration, architecture, and operational controls.
