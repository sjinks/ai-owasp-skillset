---
name: security-review-owasp-clickjacking-defense
description: Review Clickjacking Defense concerns, trust boundaries, and operational assumptions against OWASP Clickjacking Defense guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Clickjacking Defense Security Review

Apply this skill to security reviews focused on Clickjacking Defense concerns across code, configuration, architecture, and operational controls.
