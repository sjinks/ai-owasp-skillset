---
name: security-review-owasp-mobile-application-security
description: Review Mobile Application Security concerns, trust boundaries, and operational assumptions against OWASP Mobile Application Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Mobile Application Security Review

Apply this skill to security reviews focused on Mobile Application Security concerns across code, configuration, architecture, and operational controls.
