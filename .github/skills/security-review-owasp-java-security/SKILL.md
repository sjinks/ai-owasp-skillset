---
name: security-review-owasp-java-security
description: Review Java Security concerns, trust boundaries, and operational assumptions against OWASP Java Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Java Security Review

Apply this skill to security reviews focused on Java Security concerns across code, configuration, architecture, and operational controls.
