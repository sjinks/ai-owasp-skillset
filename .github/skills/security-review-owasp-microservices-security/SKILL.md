---
name: security-review-owasp-microservices-security
description: Review Microservices Security concerns, trust boundaries, and operational assumptions against OWASP Microservices Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Microservices Security Review

Apply this skill to security reviews focused on Microservices Security concerns across code, configuration, architecture, and operational controls.
