---
name: security-review-owasp-injection-prevention
description: Review Injection Prevention concerns, trust boundaries, and operational assumptions against OWASP Injection Prevention guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Injection Prevention Security Review

Apply this skill to security reviews focused on Injection Prevention concerns across code, configuration, architecture, and operational controls.
