---
name: security-review-owasp-error-handling
description: Review Error Handling concerns, trust boundaries, and operational assumptions against OWASP Error Handling guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Error Handling Security Review

Apply this skill to security reviews focused on Error Handling concerns across code, configuration, architecture, and operational controls.
