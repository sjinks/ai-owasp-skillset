---
name: security-review-owasp-django-rest-framework
description: Review Django REST Framework concerns, trust boundaries, and operational assumptions against OWASP Django REST Framework guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Django REST Framework Security Review

Apply this skill to security reviews focused on Django REST Framework concerns across code, configuration, architecture, and operational controls.
