---
name: security-review-owasp-logging
description: Review Logging concerns, trust boundaries, and operational assumptions against OWASP Logging guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Logging Security Review

Apply this skill to security reviews focused on Logging concerns across code, configuration, architecture, and operational controls.
