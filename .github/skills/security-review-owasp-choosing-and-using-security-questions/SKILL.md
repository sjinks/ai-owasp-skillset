---
name: security-review-owasp-choosing-and-using-security-questions
description: Review Choosing and Using Security Questions concerns, trust boundaries, and operational assumptions against OWASP Choosing and Using Security Questions guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Choosing and Using Security Questions Security Review

Apply this skill to security reviews focused on Choosing and Using Security Questions concerns across code, configuration, architecture, and operational controls.
