---
name: security-review-owasp-abuse-case
description: Review Abuse Case concerns, trust boundaries, and operational assumptions against OWASP Abuse Case guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Abuse Case Security Review

Apply this skill to security reviews focused on Abuse Case concerns across code, configuration, architecture, and operational controls.
