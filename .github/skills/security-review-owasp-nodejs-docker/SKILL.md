---
name: security-review-owasp-nodejs-docker
description: Review Node.js Docker concerns, trust boundaries, and operational assumptions against OWASP Node.js Docker guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Node.js Docker Security Review

Apply this skill to security reviews focused on Node.js Docker concerns across code, configuration, architecture, and operational controls.
