---
name: security-review-owasp-docker-security
description: Review Docker Security concerns, trust boundaries, and operational assumptions against OWASP Docker Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Docker Security Review

Apply this skill to security reviews focused on Docker Security concerns across code, configuration, architecture, and operational controls.
