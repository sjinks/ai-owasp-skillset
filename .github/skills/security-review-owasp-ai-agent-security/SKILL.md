---
name: security-review-owasp-ai-agent-security
description: Review AI Agent Security concerns, trust boundaries, and operational assumptions against OWASP AI Agent Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP AI Agent Security Review
