---
name: security-review-owasp-rest-assessment
description: Review REST Assessment concerns, trust boundaries, and operational assumptions against OWASP REST Assessment guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP REST Assessment Security Review

Apply this skill to security reviews focused on REST Assessment concerns across code, configuration, architecture, and operational controls.
