---
name: security-review-owasp-laravel
description: Review Laravel concerns, trust boundaries, and operational assumptions against OWASP Laravel guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Laravel Security Review

Apply this skill to security reviews focused on Laravel concerns across code, configuration, architecture, and operational controls.
