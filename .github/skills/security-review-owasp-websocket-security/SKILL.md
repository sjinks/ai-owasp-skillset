---
name: security-review-owasp-websocket-security
description: Review WebSocket Security concerns, trust boundaries, and operational assumptions against OWASP WebSocket Security guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP WebSocket Security Review

Apply this skill to security reviews focused on WebSocket Security concerns across code, configuration, architecture, and operational controls.
