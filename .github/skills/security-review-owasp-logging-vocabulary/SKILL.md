---
name: security-review-owasp-logging-vocabulary
description: Review Logging Vocabulary concerns, trust boundaries, and operational assumptions against OWASP Logging Vocabulary guidance.
argument-hint: Optionally specify the flow, component, or files to focus on
---

# OWASP Logging Vocabulary Security Review

Apply this skill to security reviews focused on Logging Vocabulary concerns across code, configuration, architecture, and operational controls.
